...
fetch:
	...
	wget -q -O $(SEAFILEDIR).zip https://github.com/gottaBoy/seafile/archive/master.zip;\
	wget -q -O $(SEAFILECLIENTDIR).zip https://github.com/gottaBoy/seafile-client/archive/master.zip
